...
html_theme_options = {
    ...
    'extra_nav_links': {
        'invenio-groups@GitHub': 'https://github.com/inveniosoftware/invenio-groups',
        'invenio-groups@PyPI': 'https://pypi.python.org/pypi/invenio-groups/',
    }
}
...
htmlhelp_basename = 'invenio-groups_namedoc'
...
latex_documents = [
  (master_doc, 'invenio-groups.tex', u'invenio-groups Documentation',
   u'CERN', 'manual'),
]
